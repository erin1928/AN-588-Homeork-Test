...
```
Challenges: I had a hard time using the strsplit() command and still am having trouble calling characters out of my character vector. By using ?strsplit() I was able to obtain some help with the command and better understand the ways in which to best apply it.
